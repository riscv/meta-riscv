Banana Pi CM6 in IO board
=========================

The BPI-CM6 is an industrial-grade RISC-V compute module powered by the
...
```
$ kas build /path/to/meta-riscv/kas/bananapi-cm6-io.yml
```
...
* `k1-bananapi-cm6-io.dtb`: device tree for Linux
...
Flash `core-image-full-cmdline-bananapi-cm6-io.rootfs.wic.gz` onto a uSD card (assuming it's accessed through `/dev/sdx`):
...
* [Banana Pi BPI-CM6 documentation](https://docs.banana-pi.org/en/BPI-CM6/BananaPi_BPI-CM6)
